...
namespace NTRSjudge
{
    public partial class Port : Form
    {
        ...
        public Port()
        {
            ...
            {
                case Main.Mode.光子云:
                    光子云ToolStripMenuItem.Checked = true;
                    GrpPort1.Enabled = true;
                    break;
                case Main.Mode.大研:
                    大研ToolStripMenuItem.Checked = true;
                    GrpPort1.Enabled = true;
                    break;
                case Main.Mode.旧机器:
                    旧机器ToolStripMenuItem.Checked = true;
                    GrpPort1.Enabled = true;
                    break;
                case Main.Mode.单片机:
                    单片机ToolStripMenuItem.Checked = true;
                    GrpPort1.Enabled = true;
                    GrpPort2.Enabled = true;
                    break;
                case Main.Mode.ONS:
                    ONSToolStripMenuItem.Checked = true;
                    GrpPort1.Enabled = true;
                    GrpPort2.Enabled = true;
                    break;
                    //GrpPort2.Enabled = true;
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            { Main.mode = Main.Mode.光子云; mode = "光子云"; }
            else if (大研ToolStripMenuItem.Checked)
            { Main.mode = Main.Mode.大研; mode = "大研"; }
            else if (旧机器ToolStripMenuItem.Checked)
            { Main.mode = Main.Mode.旧机器; mode = "旧机器"; }

            else if (单片机ToolStripMenuItem.Checked)

...
namespace StringJudge
{
    public partial class Trajectory : Form
    {
        ...
        public Trajectory()
        {
            ...
            for (int i = 0; i < StringJudge.Layout.row; i++)
            {
                for (int j = 0; j < StringJudge.Layout.col; j++)
                {
        ...
        {
            if (sequence/*sequenceList.Count*/ == StringJudge.Layout.sum)//NTRSjudge.Layout.row * NTRSjudge.Layout.col)
            {
                if (sequenceList.Count == StringJudge.Layout.sum)
                {
